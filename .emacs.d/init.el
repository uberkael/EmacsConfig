...
;;; Lisp
;;(use-package sly :ensure t :config (setq inferior-lisp-program "alisp"))
...
(custom-set-variables
 ...
 '(cursor-color "#cccccc")
 '(cursor-type 'bar)
 '(custom-enabled-themes '(leuven-dark leuven bliss ayu-grey))
 '(custom-safe-themes
